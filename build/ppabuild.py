...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Create a debian ppa packet. Make sure no extra directories are placed in parent, directories starting with '.' are skipped.")
